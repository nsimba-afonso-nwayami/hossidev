    ...
    <section id="contato" className="py-24 lg:py-40 bg-neutral-50">
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start mb-20">
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl lg:text-5xl font-light text-neutral-700 leading-tight">
                ...
                <span className="font-bold text-blue-900">próximo projeto?</span>
              </h2>
              <p className="text-neutral-600 text-lg leading-relaxed max-w-md">
                Estamos prontos para transformar sua infraestrutura. Entre em contato e solicite uma consultoria técnica especializada.
              </p>
            </div>
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-xs font-bold text-neutral-400 uppercase tracking-widest">E-mail</p>
                  <p className="text-lg font-bold text-neutral-700">contato@hossidev.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-xs font-bold text-neutral-400 uppercase tracking-widest">Telefone / WhatsApp</p>
                  <p className="text-lg font-bold text-neutral-700">+244 9XX XXX XXX</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-xs font-bold text-neutral-400 uppercase tracking-widest">Localização</p>
                  <p className="text-lg font-bold text-neutral-700">Luanda, Angola</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-neutral-100 p-8 lg:p-12 rounded-3xl shadow-sm border border-neutral-400/30">
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-neutral-700 uppercase ml-1">Nome Completo</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-neutral-700 uppercase ml-1">Seu E-mail</label>
                  <input 
                    type="email" 
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-neutral-700 uppercase ml-1">Serviço de Interesse</label>
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-neutral-700 uppercase ml-1">Mensagem</label>
                <textarea 
                  rows="4" 
        ...
        {/* MAPA GRANDE - Adicionado após o grid */}
        <div className="w-full h-112.5 lg:h-137.5 rounded-[2.5rem] overflow-hidden shadow-2xl border border-neutral-400/20 group">
          <iframe 
