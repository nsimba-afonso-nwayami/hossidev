...
export default function Sobre() {
  return (
    <section id="sobre" className="py-20 lg:py-32 bg-neutral-50 overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group">
            ...
            {/* Selo de Experiência */}
            <div className="absolute -top-10 -left-10 bg-blue-900 p-8 rounded-lg shadow-xl z-20 hidden md:block animate-bounce-slow">
              <p className="text-4xl font-bold text-neutral-50 text-center">10+</p>
              <p className="text-xs text-neutral-100 uppercase tracking-widest text-center mt-1">Anos de <br/> Mercado</p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-700 leading-tight">
                Transformando desafios complexos em <span className="text-blue-800 font-black">soluções simples.</span>
              </h2>
            </div>

            <p className="text-neutral-600 text-lg leading-relaxed">
              Na <span className="font-bold text-neutral-700">HOSSIDEV</span>, não apenas implementamos tecnologia; construímos os alicerces digitais que permitem que empresas cresçam com segurança e escalabilidade. 
            </p>
